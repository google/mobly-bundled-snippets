...
public class MbsEnums {
  ...
  public static final RpcEnum ADVERTISE_FAILURE_ERROR_CODE =
      new RpcEnum.Builder()
          ...
          .add("ADVERTISE_FAILED_DATA_TOO_LARGE", AdvertiseCallback.ADVERTISE_FAILED_DATA_TOO_LARGE)
          .add(
              "ADVERTISE_FAILED_FEATURE_UNSUPPORTED",
              AdvertiseCallback.ADVERTISE_FAILED_FEATURE_UNSUPPORTED)
          .add("ADVERTISE_FAILED_INTERNAL_ERROR", AdvertiseCallback.ADVERTISE_FAILED_INTERNAL_ERROR)
          .add(
  ...
  private static RpcEnum buildBleScanFailedErrorCodeEnum() {
    ...
    return builder
        ...
        .add("SCAN_FAILED_FEATURE_UNSUPPORTED", ScanCallback.SCAN_FAILED_FEATURE_UNSUPPORTED)
  ...
  private static RpcEnum buildStatusTypeEnum() {
    ...
    builder
        .add("GATT_SUCCESS", BluetoothGatt.GATT_SUCCESS)
        .add("GATT_CONNECTION_CONGESTED", BluetoothGatt.GATT_CONNECTION_CONGESTED)
        .add("GATT_FAILURE", BluetoothGatt.GATT_FAILURE)
        .add("GATT_INSUFFICIENT_AUTHENTICATION", BluetoothGatt.GATT_INSUFFICIENT_AUTHENTICATION)
  ...
  private static RpcEnum buildConnectStatusEnum() {
    ...
    builder
        .add("STATE_CONNECTED", BluetoothProfile.STATE_CONNECTED)
  ...
  private static RpcEnum buildPropertyTypeEnum() {
    ...
    builder
        ...
        .add("PROPERTY_WRITE_NO_RESPONSE", BluetoothGattCharacteristic.PROPERTY_WRITE_NO_RESPONSE);
    return builder.build();
  }
  ...
  private static RpcEnum buildPermissionTypeEnum() {
    ...
    builder
        .add("PERMISSION_NONE", 0)
        .add("PERMISSION_READ", BluetoothGattCharacteristic.PERMISSION_READ)
        .add("PERMISSION_READ_ENCRYPTED", BluetoothGattCharacteristic.PERMISSION_READ_ENCRYPTED)
        .add(
            "PERMISSION_READ_ENCRYPTED_MITM",
            BluetoothGattCharacteristic.PERMISSION_READ_ENCRYPTED_MITM)
        .add("PERMISSION_WRITE", BluetoothGattCharacteristic.PERMISSION_WRITE)
        .add("PERMISSION_WRITE_ENCRYPTED", BluetoothGattCharacteristic.PERMISSION_WRITE_ENCRYPTED)
        .add(
  ...
  private static RpcEnum buildBleScanModeEnum() {
    ...
    builder
        .add("SCAN_MODE_LOW_POWER", ScanSettings.SCAN_MODE_LOW_POWER)
  ...
  private static RpcEnum buildLocalHotspotFailedReason() {
    ...
    builder
        .add("ERROR_TETHERING_DISALLOWED", LocalOnlyHotspotCallback.ERROR_TETHERING_DISALLOWED)
