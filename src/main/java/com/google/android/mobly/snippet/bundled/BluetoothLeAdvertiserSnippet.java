...
public class BluetoothLeAdvertiserSnippet implements Snippet {
   ...
   *     </pre>
   *
   * @param advertiseData A JSONObject representing a {@link AdvertiseData} object will be broadcast
   *     if the operation succeeds. E.g.
   *     <pre>
   *          {
  ...
  private static class DefaultAdvertiseCallback extends AdvertiseCallback {
    ...
    public static RpcEnum ADVERTISE_FAILURE_ERROR_CODE =
        new RpcEnum.Builder()
            ...
            .add("ADVERTISE_FAILED_FEATURE_UNSUPPORTED", ADVERTISE_FAILED_FEATURE_UNSUPPORTED)
            .add("ADVERTISE_FAILED_INTERNAL_ERROR", ADVERTISE_FAILED_INTERNAL_ERROR)
            .add("ADVERTISE_FAILED_TOO_MANY_ADVERTISERS", ADVERTISE_FAILED_TOO_MANY_ADVERTISERS)
            .build();
    ...
    public void onStartSuccess(AdvertiseSettings settingsInEffect) {
      ...
      Bundle advertiseSettings = JsonSerializer.serializeBleAdvertisingSettings(settingsInEffect);
