...
public class BluetoothHeadsetSnippet implements Snippet {
   ...
   * @throws BluetoothHeadsetSnippetException If no device with the specified name is connected via
   *     HEADSET.
   */
   ...
   * @throws BluetoothHeadsetSnippetException If no device with the specified name is found or if an
   *     error occurs during the startVoiceRecognition operation.
   */
